...
''';
  ...
  Future<void> writeJxBrowserKeyToFile() async {
    final jxBrowserKey =
...
''';
    ...
    print('wrote to properties file');
    print(propertiesFile.path);
    print(await propertiesFile.length());
  }
