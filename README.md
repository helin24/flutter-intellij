...
- **[`flutter/`](flutter/)**: Flutter IntelliJ Plugin codebase, resources, agent skills, and build configuration.
- **[`dart/`](dart/)**: Dart IntelliJ Plugin codebase, resources, agent skills, and build configuration.
